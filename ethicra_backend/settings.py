"""
Django settings for ethicra_backend project.
...
SECRET_KEY = 'django-insecure-p0@6$nsdpc)ctjmtzpn=5(#%5h1@k1e4xagcfqcl!7&+v-kj0&'
...
WSGI_APPLICATION = 'ethicra_backend.wsgi.application'
# backend/settings.py

# Add this to enable email in dev (console backend)
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
DEFAULT_FROM_EMAIL = 'no-reply@ethicra.com'
